...
const char* gFragmentShaderSourceDiffusePCF[] = {
                                              ...
                                              "              SampleShadowMap(pixelCoordinates+ivec2(0,2), pointInLightClipSpace.z, bias )  +"
                                              "              SampleShadowMap(pixelCoordinates+ivec2(0,-2), pointInLightClipSpace.z, bias )  +"
                                              "              SampleShadowMap(pixelCoordinates+ivec2(2,0), pointInLightClipSpace.z, bias )  +"
                                              "              SampleShadowMap(pixelCoordinates+ivec2(-2,0), pointInLightClipSpace.z, bias )  +"
                                              "              SampleShadowMap(pixelCoordinates+ivec2(0,-1), pointInLightClipSpace.z, bias )) / 9.0;"
                                              "  color *= pcf;\n"
                                              "}\n"
};
